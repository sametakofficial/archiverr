...
from archiverr.utils.structured_logger import init_logger, get_logger
...
def rename_files(paths: List[str], media_type: str, config, client):
    ...
    from archiverr.core.matcher.matcher import match_movie, match_tv
    from archiverr.integrations.ffprobe.client import FFProbeClient
    from archiverr.core.query_engine.variable_engine import render_template, execute_query
    from archiverr.utils.nfo_writer import make_movie_nfo, make_episode_nfo, maybe_write
