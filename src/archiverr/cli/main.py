...
from archiverr.models.config import load_config_with_fallback
from archiverr.integrations.tmdb.client import TMDbClient
from archiverr.integrations.tvmaze.client import TVMazeClient
from archiverr.integrations.tvdb.client import TVDbClient
from archiverr.integrations.omdb.client import OMDbClient
from archiverr.core.scanner.scanner import collect_inputs
from archiverr.core.renamer.engine import rename_files
from archiverr.core.matcher.api_manager import APIManager
...
def parse_args():
    p = argparse.ArgumentParser(description='GoNamer-like renamer (Python).')
    # Kullanıcı çoğu zaman 1 veya daha fazla path geçecek; bazen tırnakları unutabilir.
